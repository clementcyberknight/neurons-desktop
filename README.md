# Neurons - Modular Offline Business OS
...
**Neurons** is a high-performance, **modular, offline-first desktop business operating system** built specifically for African small-and-medium enterprises (SMEs). Powered by a fine-tuned edge language model (`bau-small-1.5b.gguf`), Neurons enables local retail stores, pharmacies, warehouses, and distributors to manage staff payroll, inventory, point of sale, tasks, and financials with **zero cloud dependencies** and **sub-second edge inference**.

---

## 1. Key Features & The 6 Core Modules

```
+-------------------------------------------------------------------+
|  [1] Documents  |  [2] POS & Sales  |  [3] Inventory & Zones      |
|  [4] Staff Rota |  [5] Finance P&L  |  [6] Kanban Task Management |
+-------------------------------------------------------------------+
```
...
## 2. 100% Offline AI Copilot

Neurons Copilot features a ChatGPT-style sliding assistant drawer (`Ctrl + K`) integrated directly with the local inference engine.
...
_Launches Vite HMR with live Electron desktop window._
...
## 6. ADTC 2026 Benchmark Performance
...
| :----------------------------- | :------------- | :-------------------- | :----- |
| **Peak Memory Footprint**      | **892.4 MB**   | <= 7,000 MB (7.0 GB)  | PASS   |
| **Time to First Token (TTFT)** | **510 ms**     | <= 2,500 ms           | PASS   |
...
| **Thermal Throttle Penalty**   | **0.00 pts**   | P_thermal             | PASS   |
